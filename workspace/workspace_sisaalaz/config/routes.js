module.exports = function (app, controllers) {
    ...
    app.delete('/api/coaches/:coachId', controllers.auth.requireLogin, controllers.coaches.delete);
    app.put('/api/coaches/:coachId', controllers.auth.requireLogin, controllers.coaches.update);
